...
namespace Rules.Tests
{
    ...
    // without editing anything in rules/
    ...
    public class SeamTests
    {
        ...
        public void Resolver_CanBeReplacedEntirely()
        {
            ...
            var rival = BuiltInArchetypes.Rival(); // defense 11
        ...
        public void Resolver_CanBeDecorated_WithoutTouchingTheStandardOne()
        {
            ...
            engine.Run(BuiltInArchetypes.Barbarian(), BuiltInArchetypes.StandardEncounter());
        ...
        public void Observer_ReceivesTheWholeFight()
        {
            ...
            var result = engine.Run(BuiltInArchetypes.Barbarian(), BuiltInArchetypes.StandardEncounter());
        ...
        {
            var foes = BuiltInArchetypes.StandardEncounter(3);
            var engine = new CombatEngine(
            ...
            engine.Run(BuiltInArchetypes.Barbarian(), foes);
        ...
        public void SeededRun_IsReproducible()
        {
            EncounterResult RunOnce() =>
                new CombatEngine(new StandardResolver(new SeededRng(4242)))
                    .Run(BuiltInArchetypes.Barbarian(), BuiltInArchetypes.StandardEncounter());
