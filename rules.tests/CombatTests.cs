...
namespace Rules.Tests
{
    ...
    public class CombatTests
    {
        ...
        {
            var hero = BuiltInArchetypes.Barbarian();
            var foes = BuiltInArchetypes.StandardEncounter();
        ...
        static int WinsWith(int actions)
        {
            ...
            for (int i = 0; i < 400; i++)
                if (engine.Run(BuiltInArchetypes.Barbarian(), BuiltInArchetypes.StandardEncounter()).HeroWon)
                    wins++;
        ...
        {
            var foes = BuiltInArchetypes.StandardEncounter(6);
