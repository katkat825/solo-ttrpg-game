...
namespace Game.Tray
{
    ...
    public partial class TraySurface : Resource
    {
        ...
        //
        // fully qualified on purpose, and it has to be: Godot's ScriptPropertyDefVal generator
        // copies this initialiser into a generated partial that carries none of this file's
        // usings, so a bare ImpactPool compiles here and fails there
